# Contributing to OrionPatch

Thanks for taking the time to look at this. OrionPatch is an EF Core transactional outbox for at-least-once event publication. The project is small and the bar for contributions is "does it make the package clearer, faster, or safer without expanding the public surface needlessly."
...
```bash
git clone https://github.com/tunahanaliozturk/OrionPatch
cd OrionPatch
dotnet restore
